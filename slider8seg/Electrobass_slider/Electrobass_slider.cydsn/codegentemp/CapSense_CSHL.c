...
static const uint8 CapSense_posFiltersMask[] = {
    0x8u, 
};
...
void CapSense_BaseInit(uint32 sensor)
{
    ...
    {
        CapSense_debounceCounter[widget - (CapSense_END_OF_TOUCH_PAD_INDEX + 1u)] =  CapSense_debounce[widget];
    }
...
uint32 CapSense_CheckIsSensorActive(uint32 sensor)
{
    ...
    {
        debounceIndex = widget - (CapSense_END_OF_TOUCH_PAD_INDEX + 1u);
    }
