...
*/
     ...
     *  @{
     */
        #define blue_LED_INTR_NONE      (uint16)(0x0000u)
        #define blue_LED_INTR_RISING    (uint16)(0x0001u)
        #define blue_LED_INTR_FALLING   (uint16)(0x0002u)
        #define blue_LED_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define blue_LED_INTR_MASK      (0x01u) 
#endif /* (blue_LED__INTSTAT) */
...
/* SIO registers */
#if defined(blue_LED__SIO_CFG)
    #define blue_LED_SIO_HYST_EN        (* (reg8 *) blue_LED__SIO_HYST_EN)
    #define blue_LED_SIO_REG_HIFREQ     (* (reg8 *) blue_LED__SIO_REG_HIFREQ)
    #define blue_LED_SIO_CFG            (* (reg8 *) blue_LED__SIO_CFG)
    #define blue_LED_SIO_DIFF           (* (reg8 *) blue_LED__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define blue_LED_0_INTTYPE_REG 		(* (reg8 *) blue_LED__0__INTTYPE)
#endif /* (blue_LED__INTSTAT) */

#endif /* CY_PSOC5A... */

#endif /*  CY_PINS_blue_LED_H */
