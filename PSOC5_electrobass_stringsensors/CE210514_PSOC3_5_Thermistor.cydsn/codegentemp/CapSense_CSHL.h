...
#define CapSense_RAW_FILTER_MASK            (32u)
...
#define CapSense_TOTAL_BUTTONS_COUNT                 (8u)
...
#define CapSense_UNUSED_DEBOUNCE_COUNTER_INDEX   (8u)


#define CapSense_END_OF_SLIDERS_INDEX   (0u)
#define CapSense_END_OF_TOUCH_PAD_INDEX   (0u)
#define CapSense_END_OF_BUTTONS_INDEX   (7u)
#define CapSense_END_OF_MATRIX_BUTTONS_INDEX   (7u)
#define CapSense_END_OF_WIDGETS_INDEX   (8u)
