...
uint8 CapSense_CompCH1_initVar = 0u;

/* Internal functions definitoin */
static void CapSense_CompCH1_trimAdjust(uint8 nibble) ;

/* static CapSense_CompCH1_backupStruct  CapSense_CompCH1_backup; */
#if (CY_PSOC5A)
    static CapSense_CompCH1_LOWPOWER_BACKUP_STRUCT  CapSense_CompCH1_lowPowerBackup;
#endif /* CY_PSOC5A */

/* variable to decide whether or not to restore the control register in 
   Enable() API for PSoC5A only */
#if (CY_PSOC5A)
    static uint8 CapSense_CompCH1_restoreReg = 0u;
#endif /* CY_PSOC5A */


/*******************************************************************************
* Function Name: CapSense_CompCH1_Init
********************************************************************************
*
* Summary:
...
void CapSense_CompCH1_Init(void) 
{
    ...
    CapSense_CompCH1_SetSpeed(CapSense_CompCH1_DEFAULT_SPEED);

    /* Set default Hysteresis */
    #if ( CapSense_CompCH1_DEFAULT_HYSTERESIS == 0u )
        CapSense_CompCH1_CR |= CapSense_CompCH1_HYST_OFF;
    #else
        CapSense_CompCH1_CR &= (uint8)(~CapSense_CompCH1_HYST_OFF);
    #endif /* CapSense_CompCH1_DEFAULT_HYSTERESIS == 0u */
    /* Power down override feature is not supported for PSoC5A. */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Set default Power Down Override */
        #if ( CapSense_CompCH1_DEFAULT_PWRDWN_OVRD == 0u )
            CapSense_CompCH1_CR &= (uint8)(~CapSense_CompCH1_PWRDWN_OVRD);
        #else 
            CapSense_CompCH1_CR |= CapSense_CompCH1_PWRDWN_OVRD;
        #endif /* CapSense_CompCH1_DEFAULT_PWRDWN_OVRD == 0u */
    #endif /* CY_PSOC3 || CY_PSOC5LP */
    
    /* Set mux always on logic */
    CapSense_CompCH1_CR |= CapSense_CompCH1_MX_AO;

    /* Set default sync */
    CapSense_CompCH1_CLK &= (uint8)(~CapSense_CompCH1_SYNCCLK_MASK);
    #if ( CapSense_CompCH1_DEFAULT_BYPASS_SYNC == 0u )
        CapSense_CompCH1_CLK |= CapSense_CompCH1_SYNC_CLK_EN;
    #else
        CapSense_CompCH1_CLK |= CapSense_CompCH1_BYPASS_SYNC;
    #endif /* CapSense_CompCH1_DEFAULT_BYPASS_SYNC == 0u */
}


/*******************************************************************************
* Function Name: CapSense_CompCH1_Enable
********************************************************************************
*
* Summary:
...
{
    CapSense_CompCH1_PWRMGR |= CapSense_CompCH1_ACT_PWR_EN;
    CapSense_CompCH1_STBY_PWRMGR |= CapSense_CompCH1_STBY_PWR_EN;
     
     /* This is to restore the value of register CR which is saved 
    in prior to the modification in stop() API */
    #if (CY_PSOC5A)
        if(CapSense_CompCH1_restoreReg == 1u)
        {
            CapSense_CompCH1_CR = CapSense_CompCH1_lowPowerBackup.compCRReg;

            /* Clear the flag */
            CapSense_CompCH1_restoreReg = 0u;
        }
    #endif /* CY_PSOC5A */
}
...
/*******************************************************************************
* Function Name: CapSense_CompCH1_Start
********************************************************************************
*
* Summary:
...
*
* Global variables:
*  CapSense_CompCH1_initVar: Is modified when this function is called for the 
...
void CapSense_CompCH1_Start(void) 
{
    ...
    if ( CapSense_CompCH1_initVar == 0u )
    {
        CapSense_CompCH1_Init();
        
        CapSense_CompCH1_initVar = 1u;
    }   
...
/*******************************************************************************
* Function Name: CapSense_CompCH1_Stop
********************************************************************************
*
* Summary:
...
void CapSense_CompCH1_Stop(void) 
{
    ...
    CapSense_CompCH1_PWRMGR &= (uint8)(~CapSense_CompCH1_ACT_PWR_EN);
    CapSense_CompCH1_STBY_PWRMGR &= (uint8)(~CapSense_CompCH1_STBY_PWR_EN);
    
    #if (CY_PSOC5A)
        /* Enable the variable */
        CapSense_CompCH1_restoreReg = 1u;

        /* Save the control register before clearing it */
        CapSense_CompCH1_lowPowerBackup.compCRReg = CapSense_CompCH1_CR;
        CapSense_CompCH1_CR = CapSense_CompCH1_COMP_REG_CLR;
    #endif /* CY_PSOC5A */
}


/*******************************************************************************
* Function Name: CapSense_CompCH1_SetSpeed
********************************************************************************
*
* Summary:
...
void CapSense_CompCH1_SetSpeed(uint8 speed) 
{
    ...
    CapSense_CompCH1_CR = (CapSense_CompCH1_CR & (uint8)(~CapSense_CompCH1_PWR_MODE_MASK)) |
                           (speed & CapSense_CompCH1_PWR_MODE_MASK);

    /* Set trim value for high speed comparator */
    if(speed == CapSense_CompCH1_HIGHSPEED)
    {
        /* PSoC5A */
        #if (CY_PSOC5A)
            CapSense_CompCH1_TR = CapSense_CompCH1_HS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            CapSense_CompCH1_TR0 = CapSense_CompCH1_HS_TRIM_TR0;
            CapSense_CompCH1_TR1 = CapSense_CompCH1_HS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
    else
    {
    /* PSoC5A */
        #if (CY_PSOC5A)
            CapSense_CompCH1_TR = CapSense_CompCH1_LS_TRIM_TR0;
        #endif /* CY_PSOC5A */
        
        /* PSoC3, PSoC5LP or later */
        #if (CY_PSOC3 || CY_PSOC5LP) 
            CapSense_CompCH1_TR0 = CapSense_CompCH1_LS_TRIM_TR0;
            CapSense_CompCH1_TR1 = CapSense_CompCH1_LS_TRIM_TR1;
        #endif /* CY_PSOC3 || CY_PSOC5LP */
    }
...
/*******************************************************************************
* Function Name: CapSense_CompCH1_GetCompare
********************************************************************************
*
* Summary:
...
{
    return( CapSense_CompCH1_WRK & CapSense_CompCH1_CMP_OUT_MASK);
}


/*******************************************************************************
* Function Name: CapSense_CompCH1_trimAdjust
********************************************************************************
*
* Summary:
...
static void CapSense_CompCH1_trimAdjust(uint8 nibble) 
{
    ...
    cmpState = CapSense_CompCH1_WRK & CapSense_CompCH1_CMP_OUT_MASK;
    ...
    {    
        ...
        if ( cmpState != 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CompCH1_TR |= CapSense_CompCH1_CMP_TRIM1_DIR;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CompCH1_TR0 |= CapSense_CompCH1_CMP_TR0_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    else
    {
        ...
        if ( cmpState == 0u )
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CompCH1_TR |= CapSense_CompCH1_CMP_TRIM2_DIR; 
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CompCH1_TR1 |= CapSense_CompCH1_CMP_TR1_DIR;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
    }
    ...
    for ( trimCnt = 0u; trimCnt < trimCntMax; trimCnt++ )
	{
        if (nibble == 0u)
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CompCH1_TR += 1u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CompCH1_TR0 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        else
        {
            /* PSoC5A */
            #if (CY_PSOC5A)
                CapSense_CompCH1_TR += 0x10u;
            #endif /* CY_PSOC5A */
            
            /* PSoC3, PSoC5LP or later */
            #if (CY_PSOC3 || CY_PSOC5LP)
                CapSense_CompCH1_TR1 += 1u;
            #endif /* CY_PSOC3 || CY_PSOC5LP */
        }
        ...
        if ((CapSense_CompCH1_WRK & CapSense_CompCH1_CMP_OUT_MASK) != cmpState)
        {
...
/*******************************************************************************
* Function Name: CapSense_CompCH1_ZeroCal
********************************************************************************
*
* Summary:
...
uint16 CapSense_CompCH1_ZeroCal(void) 
{
    ...
    tmpSW0 = CapSense_CompCH1_SW0;
    tmpSW2 = CapSense_CompCH1_SW2;
    tmpSW3 = CapSense_CompCH1_SW3;

     /* Clear routing for inP, retain routing for inN */
    CapSense_CompCH1_SW0 = 0x00u;
    CapSense_CompCH1_SW2 = 0x00u;
    CapSense_CompCH1_SW3 = tmpSW3 & (uint8)(~CapSense_CompCH1_CMP_SW3_INPCTL_MASK);

    /* Preserve original configuration
     * - turn off Hysteresis
     * - set calibration bit - shorts inN to inP
    */
    tmpCR = CapSense_CompCH1_CR;
    CapSense_CompCH1_CR |= (CapSense_CompCH1_CAL_ON | CapSense_CompCH1_HYST_OFF);
    
    /* Write default low values to trim register - no offset adjust */
    /* PSoC5A */
    #if (CY_PSOC5A)
        CapSense_CompCH1_TR = CapSense_CompCH1_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        CapSense_CompCH1_TR0 = CapSense_CompCH1_DEFAULT_CMP_TRIM;
        CapSense_CompCH1_TR1 = CapSense_CompCH1_DEFAULT_CMP_TRIM;
    #endif /* CY_PSOC3 || CY_PSOC5LP */
	
	/* Two phase trim - slow modes, one phase trim - for fast */ 
    if ( (CapSense_CompCH1_CR & CapSense_CompCH1_PWR_MODE_MASK) == CapSense_CompCH1_PWR_MODE_FAST)
    {
        CapSense_CompCH1_trimAdjust(0u);
    }
    else /* default to trim for fast modes */
    {
        CapSense_CompCH1_trimAdjust(1u);
		CapSense_CompCH1_trimAdjust(0u);
    }
   
    /* Restore Config Register */
    CapSense_CompCH1_CR = tmpCR;
    
    /* Restore routing registers for inP */
    CapSense_CompCH1_SW0 = tmpSW0;
    CapSense_CompCH1_SW2 = tmpSW2;
    CapSense_CompCH1_SW3 = tmpSW3;
    
    /* PSoC5A */
    #if (CY_PSOC5A)
        return (uint16) CapSense_CompCH1_TR;
    #endif /* CY_PSOC5A */
    
    /* PSoC3, PSoC5LP or later */
    #if (CY_PSOC3 || CY_PSOC5LP)
        return ((uint16)((uint16)CapSense_CompCH1_TR1 << 8u) | (CapSense_CompCH1_TR0));        
    #endif /* CY_PSOC3 || CY_PSOC5LP */
}


/*******************************************************************************
* Function Name: CapSense_CompCH1_LoadTrim
********************************************************************************
*
* Summary:
...
void CapSense_CompCH1_LoadTrim(uint16 trimVal) 
{
    ...
    /*******************************************************************************
    * Function Name: CapSense_CompCH1_PwrDwnOverrideEnable
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: CapSense_CompCH1_PwrDwnOverrideDisable
    ********************************************************************************
    *
    * Summary:
