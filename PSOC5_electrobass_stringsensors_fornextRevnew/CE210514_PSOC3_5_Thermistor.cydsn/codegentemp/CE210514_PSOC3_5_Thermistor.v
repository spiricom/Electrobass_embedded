...
// IDAC8_v2_0(Current=128, Data_Source=0, Hardware_Enable=false, IDAC_Range=4, IDAC_Speed=2, Initial_Value=128, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC8_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC8_1, CY_INSTANCE_SHORT_NAME=IDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=IDAC8_1, )
module IDAC8_v2_0_0 (
    data,
    en,
    iOut,
...
module ADC_DelSig_v3_30_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("fbda9b79-9f46-4360-b7f1-e0d7a25d459b/20681f4c-d171-47ae-a1cb-d832cd711191"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
// Comp_v2_0(Hysteresis=0, Pd_Override=0, Polarity=0, PSOC5A=false, Speed=0, Sync=1, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMMENT=, CY_COMPONENT_NAME=Comp_v2_0, CY_CONFIG_TITLE=CompCH0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:CompCH0, CY_INSTANCE_SHORT_NAME=CompCH0, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=CapSense_CompCH0, )
module Comp_v2_0_2 (
    clock,
    CmpOut,
    Vminus,
...
module CapSense_CSD_v3_50_6 (
	...
	cy_psoc3_pins_v1_10
		#(.id("02c2334d-9363-4f4e-adbb-de319d798079/232398c5-3876-4e07-8f5b-7cd7657055e2"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module USBFS_v3_20_8 (
    ...
    CyStatusReg_v1_90 Vbus_ps (
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Vbus_ps.Bit0Mode = 0;
    defparam Vbus_ps.Bit1Mode = 0;
    defparam Vbus_ps.Bit2Mode = 0;
    defparam Vbus_ps.Bit3Mode = 0;
    defparam Vbus_ps.Bit4Mode = 0;
    defparam Vbus_ps.Bit5Mode = 0;
    defparam Vbus_ps.Bit6Mode = 0;
    defparam Vbus_ps.Bit7Mode = 0;
    defparam Vbus_ps.BusDisplay = 0;
    defparam Vbus_ps.Interrupt = 0;
    defparam Vbus_ps.MaskValue = 0;
    defparam Vbus_ps.NumInputs = 1;
...
module ADC_SAR_v3_10_9 (
	...
	cy_psoc3_pins_v1_10
		#(.id("d5fcdb55-18e5-448b-a411-5f774d9a0a4c/dea208d9-07b0-438b-a5e0-ac5d207f2658/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    defparam AMux_1_CYAMUXSIDE_A.connect_mode = 2;
    ...
    defparam AMux_1_CYAMUXSIDE_B.connect_mode = 2;
    ...
    defparam IDAC8_1.Initial_Value = 128;
	...
	wire [0:0] tmpOE__ExtMUXS0_net;
	wire [0:0] tmpFB_0__ExtMUXS0_net;
	wire [0:0] tmpIO_0__ExtMUXS0_net;
	wire [0:0] tmpINTERRUPT_0__ExtMUXS0_net;
	electrical [0:0] tmpSIOVREF__ExtMUXS0_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		ExtMUXS0
		 (.oe(tmpOE__ExtMUXS0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ExtMUXS0_net[0:0]}),
		  .io({tmpIO_0__ExtMUXS0_net[0:0]}),
		  .siovref(tmpSIOVREF__ExtMUXS0_net),
		  .interrupt({tmpINTERRUPT_0__ExtMUXS0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ExtMUXS0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__V_T_1_1_net;
	wire [0:0] tmpFB_0__V_T_1_1_net;
	wire [0:0] tmpIO_0__V_T_1_1_net;
	wire [0:0] tmpINTERRUPT_0__V_T_1_1_net;
	electrical [0:0] tmpSIOVREF__V_T_1_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a3243a0e-e021-4446-be9b-bf8e8ea92640"),
		  ...
		  .input_buffer_sel(2'b00))
		V_T_1_1
		 (.oe(tmpOE__V_T_1_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_T_1_1_net[0:0]}),
		  .analog({Net_1102}),
		  .io({tmpIO_0__V_T_1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__V_T_1_1_net),
		  .interrupt({tmpINTERRUPT_0__V_T_1_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_T_1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__knob_1_01_net;
	wire [0:0] tmpFB_0__knob_1_01_net;
	wire [0:0] tmpIO_0__knob_1_01_net;
	wire [0:0] tmpINTERRUPT_0__knob_1_01_net;
	electrical [0:0] tmpSIOVREF__knob_1_01_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		knob_1_01
		 (.oe(tmpOE__knob_1_01_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__knob_1_01_net[0:0]}),
		  .analog({Net_987}),
		  .io({tmpIO_0__knob_1_01_net[0:0]}),
		  .siovref(tmpSIOVREF__knob_1_01_net),
		  .interrupt({tmpINTERRUPT_0__knob_1_01_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__knob_1_01_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__joy_y_23_net;
	wire [0:0] tmpFB_0__joy_y_23_net;
	wire [0:0] tmpIO_0__joy_y_23_net;
	wire [0:0] tmpINTERRUPT_0__joy_y_23_net;
	electrical [0:0] tmpSIOVREF__joy_y_23_net;

	cy_psoc3_pins_v1_10
		#(.id("a72526bf-1cbd-45e8-a58a-30f5d43b44e6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		joy_y_23
		 (.oe(tmpOE__joy_y_23_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__joy_y_23_net[0:0]}),
		  .analog({Net_991}),
		  .io({tmpIO_0__joy_y_23_net[0:0]}),
		  .siovref(tmpSIOVREF__joy_y_23_net),
		  .interrupt({tmpINTERRUPT_0__joy_y_23_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	wire [0:0] tmpOE__joy_x_25_net;
	wire [0:0] tmpFB_0__joy_x_25_net;
	wire [0:0] tmpIO_0__joy_x_25_net;
	wire [0:0] tmpINTERRUPT_0__joy_x_25_net;
	electrical [0:0] tmpSIOVREF__joy_x_25_net;

	cy_psoc3_pins_v1_10
		#(.id("310bc56e-d62c-4f4a-b552-02e2977d7bb7"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		joy_x_25
		 (.oe(tmpOE__joy_x_25_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__joy_x_25_net[0:0]}),
		  .analog({Net_990}),
		  .io({tmpIO_0__joy_x_25_net[0:0]}),
		  .siovref(tmpSIOVREF__joy_x_25_net),
		  .interrupt({tmpINTERRUPT_0__joy_x_25_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__joy_x_25_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("9e61e13f-b094-4221-9e02-28a8725ae97e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__IDAC_OUT_net;
	wire [0:0] tmpFB_0__IDAC_OUT_net;
	wire [0:0] tmpIO_0__IDAC_OUT_net;
	wire [0:0] tmpINTERRUPT_0__IDAC_OUT_net;
	electrical [0:0] tmpSIOVREF__IDAC_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("24a3b221-209c-4681-afa7-391af25738e4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		IDAC_OUT
		 (.oe(tmpOE__IDAC_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IDAC_OUT_net[0:0]}),
		  .analog({Net_777}),
		  .io({tmpIO_0__IDAC_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__IDAC_OUT_net),
		  .interrupt({tmpINTERRUPT_0__IDAC_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("f4699043-c496-404d-91bb-e190ee00f71b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpINTERRUPT_0__knob_2_36_net;
	electrical [0:0] tmpSIOVREF__knob_2_36_net;

	cy_psoc3_pins_v1_10
		#(.id("f43b294d-be70-4300-b350-06c05fd7dfb1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		knob_2_36
		 (.oe(tmpOE__knob_2_36_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__knob_2_36_net[0:0]}),
		  .analog({Net_988}),
		  .io({tmpIO_0__knob_2_36_net[0:0]}),
		  .siovref(tmpSIOVREF__knob_2_36_net),
		  .interrupt({tmpINTERRUPT_0__knob_2_36_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__knob_2_36_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ExtMUX_EN_net;
	wire [0:0] tmpFB_0__ExtMUX_EN_net;
	wire [0:0] tmpIO_0__ExtMUX_EN_net;
	wire [0:0] tmpINTERRUPT_0__ExtMUX_EN_net;
	electrical [0:0] tmpSIOVREF__ExtMUX_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("2697140a-091c-4334-9b86-87bf121e44bd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ExtMUX_EN
		 (.oe(tmpOE__ExtMUX_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ExtMUX_EN_net[0:0]}),
		  .io({tmpIO_0__ExtMUX_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__ExtMUX_EN_net),
		  .interrupt({tmpINTERRUPT_0__ExtMUX_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ExtMUX_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__ExtMUXS1_net;
	wire [0:0] tmpFB_0__ExtMUXS1_net;
	wire [0:0] tmpIO_0__ExtMUXS1_net;
	wire [0:0] tmpINTERRUPT_0__ExtMUXS1_net;
	electrical [0:0] tmpSIOVREF__ExtMUXS1_net;

	cy_psoc3_pins_v1_10
		#(.id("fe75def9-8d90-482f-b816-5f18b44472a3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ExtMUXS1
		 (.oe(tmpOE__ExtMUXS1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ExtMUXS1_net[0:0]}),
		  .io({tmpIO_0__ExtMUXS1_net[0:0]}),
		  .siovref(tmpSIOVREF__ExtMUXS1_net),
		  .interrupt({tmpINTERRUPT_0__ExtMUXS1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPI_ready_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__enter_net;
	wire [0:0] tmpFB_0__enter_net;
	wire [0:0] tmpIO_0__enter_net;
	wire [0:0] tmpINTERRUPT_0__enter_net;
	electrical [0:0] tmpSIOVREF__enter_net;

	cy_psoc3_pins_v1_10
		#(.id("ed20aee1-1d96-4218-b2a1-c122da6fbb54"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		enter
		 (.oe(tmpOE__enter_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__enter_net[0:0]}),
		  .io({tmpIO_0__enter_net[0:0]}),
		  .siovref(tmpSIOVREF__enter_net),
		  .interrupt({tmpINTERRUPT_0__enter_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__enter_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CV_pedal_sense_net;
	wire [0:0] tmpFB_0__CV_pedal_sense_net;
	wire [0:0] tmpIO_0__CV_pedal_sense_net;
	wire [0:0] tmpINTERRUPT_0__CV_pedal_sense_net;
	electrical [0:0] tmpSIOVREF__CV_pedal_sense_net;

	cy_psoc3_pins_v1_10
		#(.id("daf46403-d9c0-4652-adaf-6f8316c479db"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		CV_pedal_sense
		 (.oe(tmpOE__CV_pedal_sense_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CV_pedal_sense_net[0:0]}),
		  .io({tmpIO_0__CV_pedal_sense_net[0:0]}),
		  .siovref(tmpSIOVREF__CV_pedal_sense_net),
		  .interrupt({tmpINTERRUPT_0__CV_pedal_sense_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CV_pedal_sense_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__V_T_1_2_net;
	wire [0:0] tmpFB_0__V_T_1_2_net;
	wire [0:0] tmpIO_0__V_T_1_2_net;
	wire [0:0] tmpINTERRUPT_0__V_T_1_2_net;
	electrical [0:0] tmpSIOVREF__V_T_1_2_net;

	cy_psoc3_pins_v1_10
		#(.id("f8c32dd3-df80-4ddd-b67f-9e7803ebe88e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		V_T_1_2
		 (.oe(tmpOE__V_T_1_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_T_1_2_net[0:0]}),
		  .analog({Net_945}),
		  .io({tmpIO_0__V_T_1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__V_T_1_2_net),
		  .interrupt({tmpINTERRUPT_0__V_T_1_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_T_1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__V_H_net;
	wire [0:0] tmpFB_0__V_H_net;
	wire [0:0] tmpIO_0__V_H_net;
	wire [0:0] tmpINTERRUPT_0__V_H_net;
	electrical [0:0] tmpSIOVREF__V_H_net;

	cy_psoc3_pins_v1_10
		#(.id("4deb2bfb-7cb2-4713-bb2e-e03dbe19130c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		V_H
		 (.oe(tmpOE__V_H_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_H_net[0:0]}),
		  .analog({Net_1105}),
		  .io({tmpIO_0__V_H_net[0:0]}),
		  .siovref(tmpSIOVREF__V_H_net),
		  .interrupt({tmpINTERRUPT_0__V_H_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_H_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("1518ce35-a8ec-442f-ae39-0add8c0bfc45"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__necksense2_net;
	wire [0:0] tmpFB_0__necksense2_net;
	wire [0:0] tmpIO_0__necksense2_net;
	wire [0:0] tmpINTERRUPT_0__necksense2_net;
	electrical [0:0] tmpSIOVREF__necksense2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		necksense2
		 (.oe(tmpOE__necksense2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__necksense2_net[0:0]}),
		  .io({tmpIO_0__necksense2_net[0:0]}),
		  .siovref(tmpSIOVREF__necksense2_net),
		  .interrupt({tmpINTERRUPT_0__necksense2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__necksense2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__necksense1_net;
	wire [0:0] tmpFB_0__necksense1_net;
	wire [0:0] tmpIO_0__necksense1_net;
	wire [0:0] tmpINTERRUPT_0__necksense1_net;
	electrical [0:0] tmpSIOVREF__necksense1_net;

	cy_psoc3_pins_v1_10
		#(.id("c39c7e8e-6b6f-4c10-aa3c-548908a566d9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		necksense1
		 (.oe(tmpOE__necksense1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__necksense1_net[0:0]}),
		  .io({tmpIO_0__necksense1_net[0:0]}),
		  .siovref(tmpSIOVREF__necksense1_net),
		  .interrupt({tmpINTERRUPT_0__necksense1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__necksense1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d6c1866c-d59f-4822-a833-6151b0ab27d5"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("643c0ba5-a22b-4ea4-aaa4-7a8606a8c41e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SCLK_2_net;
	wire [0:0] tmpFB_0__SCLK_2_net;
	wire [0:0] tmpIO_0__SCLK_2_net;
	wire [0:0] tmpINTERRUPT_0__SCLK_2_net;
	electrical [0:0] tmpSIOVREF__SCLK_2_net;

	cy_psoc3_pins_v1_10
		#(.id("0a9b0dac-87ad-4b5d-aba9-d2257bd84b93"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		SCLK_2
		 (.oe(tmpOE__SCLK_2_net),
		  .y({Net_1114}),
		  .fb({tmpFB_0__SCLK_2_net[0:0]}),
		  .io({tmpIO_0__SCLK_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SCLK_2_net),
		  .interrupt({tmpINTERRUPT_0__SCLK_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("fa73ce71-bb13-4bb6-bc10-ec947d1506f0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__cv_pedal_net;
	wire [0:0] tmpFB_0__cv_pedal_net;
	wire [0:0] tmpIO_0__cv_pedal_net;
	wire [0:0] tmpINTERRUPT_0__cv_pedal_net;
	electrical [0:0] tmpSIOVREF__cv_pedal_net;

	cy_psoc3_pins_v1_10
		#(.id("6b546c17-ee2c-48a9-aeb4-6bdd5c30d0bf"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		cv_pedal
		 (.oe(tmpOE__cv_pedal_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cv_pedal_net[0:0]}),
		  .analog({Net_993}),
		  .io({tmpIO_0__cv_pedal_net[0:0]}),
		  .siovref(tmpSIOVREF__cv_pedal_net),
		  .interrupt({tmpINTERRUPT_0__cv_pedal_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cv_pedal_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	electrical [0:0] tmpSIOVREF__vBusPin_net;

	cy_psoc3_pins_v1_10
		#(.id("07089094-e99b-49f2-81f6-b01912599db7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		vBusPin
		 (.oe(tmpOE__vBusPin_net),
		  .y({1'b0}),
		  .fb({Net_1177}),
		  .io({tmpIO_0__vBusPin_net[0:0]}),
		  .siovref(tmpSIOVREF__vBusPin_net),
		  .interrupt({Net_1178}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__vBusPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__ExtMUX_EN2_net;
	wire [0:0] tmpFB_0__ExtMUX_EN2_net;
	wire [0:0] tmpIO_0__ExtMUX_EN2_net;
	wire [0:0] tmpINTERRUPT_0__ExtMUX_EN2_net;
	electrical [0:0] tmpSIOVREF__ExtMUX_EN2_net;

	cy_psoc3_pins_v1_10
		#(.id("33eff24c-cb55-4a2e-8565-1ea38ff0cb28"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		ExtMUX_EN2
		 (.oe(tmpOE__ExtMUX_EN2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ExtMUX_EN2_net[0:0]}),
		  .io({tmpIO_0__ExtMUX_EN2_net[0:0]}),
		  .siovref(tmpSIOVREF__ExtMUX_EN2_net),
		  .interrupt({tmpINTERRUPT_0__ExtMUX_EN2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ExtMUX_EN2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__necksense3_net;
	wire [0:0] tmpFB_0__necksense3_net;
	wire [0:0] tmpIO_0__necksense3_net;
	wire [0:0] tmpINTERRUPT_0__necksense3_net;
	electrical [0:0] tmpSIOVREF__necksense3_net;

	cy_psoc3_pins_v1_10
		#(.id("9c62d10a-7574-4f88-a25e-689838a419d1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		necksense3
		 (.oe(tmpOE__necksense3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__necksense3_net[0:0]}),
		  .io({tmpIO_0__necksense3_net[0:0]}),
		  .siovref(tmpSIOVREF__necksense3_net),
		  .interrupt({tmpINTERRUPT_0__necksense3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__necksense3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__necksense4_net;
	wire [0:0] tmpFB_0__necksense4_net;
	wire [0:0] tmpIO_0__necksense4_net;
	wire [0:0] tmpINTERRUPT_0__necksense4_net;
	electrical [0:0] tmpSIOVREF__necksense4_net;

	cy_psoc3_pins_v1_10
		#(.id("d7f396f5-7b0a-42bf-9703-44e0eb77e8e7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		necksense4
		 (.oe(tmpOE__necksense4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__necksense4_net[0:0]}),
		  .io({tmpIO_0__necksense4_net[0:0]}),
		  .siovref(tmpSIOVREF__necksense4_net),
		  .interrupt({tmpINTERRUPT_0__necksense4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__necksense4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
