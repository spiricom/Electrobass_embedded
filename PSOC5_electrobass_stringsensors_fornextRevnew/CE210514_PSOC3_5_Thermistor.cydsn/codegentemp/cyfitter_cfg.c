...
static void cfg_dma_init(void)
{
	...
	DMAINITSEC static const struct td_t CYCODE CFG_TD_LIST0[] = {
		...
		{ 32u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYREG_PRT5_DR) },	/* TD 10 */
		{ 128u, 0xFEu, 0x22u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE) },	/* TD 11 */
		...
		{ 8u, 0x19u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYREG_IDMUX_IRQ_CTL0) },	/* TD 24 */
		{ 128u, 0x1Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U0_BASE) },	/* TD 25 */
		{ 128u, 0x1Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P0_U1_BASE) },	/* TD 26 */
		{ 128u, 0x1Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_U0_BASE) },	/* TD 27 */
		{ 128u, 0x1Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P1_U1_BASE) },	/* TD 28 */
		{ 128u, 0x1Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U0_BASE) },	/* TD 29 */
		{ 128u, 0x1Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P2_U1_BASE) },	/* TD 30 */
		...
		{ 128u, 0x24u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U0_BASE) },	/* TD 35 */
		{ 128u, 0x25u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P5_U1_BASE) },	/* TD 36 */
		{ 128u, 0x26u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_U0_BASE) },	/* TD 37 */
		{ 128u, 0x27u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P6_U1_BASE) },	/* TD 38 */
		{ 128u, 0x28u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P7_U0_BASE) },	/* TD 39 */
		{ 128u, 0x29u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B0_P7_U1_BASE) },	/* TD 40 */
		{ 128u, 0x2Au, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U0_BASE) },	/* TD 41 */
		{ 128u, 0x2Bu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_B1_P2_U1_BASE) },	/* TD 42 */
		...
		{ 128u, 0x5Cu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI3_BASE + 0x00000080u) },	/* TD 91 */
		{ 128u, 0x5Du, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE) },	/* TD 92 */
		{ 128u, 0x5Eu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI2_BASE + 0x00000080u) },	/* TD 93 */
		{ 128u, 0x5Fu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE) },	/* TD 94 */
		{ 128u, 0x60u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI1_BASE + 0x00000080u) },	/* TD 95 */
		{ 128u, 0x61u, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE) },	/* TD 96 */
		{ 128u, 0xFEu, 0x23u, (uint16)(uint32)(0u), (uint16)(CYDEV_UCFG_DSI0_BASE + 0x00000080u) },	/* TD 97 */
	};
	...
	static const void * const CFG_TD_ADDR0[] = {
		...
		(const void *)(BS_IDMUX_IRQ_VAL),	/* TD 24 */
		(const void *)(BS_UDB_1_5_0_CONFIG_VAL),	/* TD 25 */
		(const void *)(BS_UDB_1_5_1_CONFIG_VAL),	/* TD 26 */
		(const void *)(BS_UDB_1_4_1_CONFIG_VAL),	/* TD 27 */
		(const void *)(BS_UDB_1_4_0_CONFIG_VAL),	/* TD 28 */
		(const void *)(BS_UDB_1_3_0_CONFIG_VAL),	/* TD 29 */
		(const void *)(BS_UDB_1_3_1_CONFIG_VAL),	/* TD 30 */
		...
		(const void *)(BS_UDB_0_3_0_CONFIG_VAL),	/* TD 35 */
		(const void *)(BS_UDB_0_3_1_CONFIG_VAL),	/* TD 36 */
		(const void *)(BS_UDB_0_4_1_CONFIG_VAL),	/* TD 37 */
		(const void *)(BS_UDB_0_4_0_CONFIG_VAL),	/* TD 38 */
		(const void *)(BS_UDB_0_5_0_CONFIG_VAL),	/* TD 39 */
		(const void *)(BS_UDB_0_5_1_CONFIG_VAL),	/* TD 40 */
		(const void *)(BS_UDB_1_0_0_CONFIG_VAL),	/* TD 41 */
		(const void *)(BS_UDB_1_0_1_CONFIG_VAL),	/* TD 42 */
		...
		(const void *)(BS_DSI3_2_HV_ROUTING_VAL),	/* TD 91 */
		(const void *)(BS_DSISWITCH_1_3_VAL),	/* TD 92 */
		(const void *)(BS_DSI3_3_HV_ROUTING_VAL),	/* TD 93 */
		(const void *)(BS_DSISWITCH_1_4_VAL),	/* TD 94 */
		(const void *)(BS_DSI3_4_HV_ROUTING_VAL),	/* TD 95 */
		(const void *)(BS_DSISWITCH_1_5_VAL),	/* TD 96 */
		(const void *)(BS_DSI3_5_HV_ROUTING_VAL),	/* TD 97 */
	};
	...
	CY_SET_REG16((void CYXDATA *)CYREG_PHUB_TDMEM0_ORIG_TD0, 97u*8u);	/* transfer size */
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_B0_P7_U0_CFG24), 0x84040404u);
