...
#define CapSense_Sns_INTR_ALL	 ((uint16)(CapSense_Sns_0_INTR| CapSense_Sns_1_INTR| CapSense_Sns_2_INTR| CapSense_Sns_3_INTR| CapSense_Sns_4_INTR| CapSense_Sns_5_INTR| CapSense_Sns_6_INTR| CapSense_Sns_7_INTR| CapSense_Sns_8_INTR| CapSense_Sns_9_INTR| CapSense_Sns_10_INTR))
...
#define CapSense_Sns_LinearSlider0_e5__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__5__SHIFT*2u)))
...
#define CapSense_Sns_LinearSlider0_e6__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__6__SHIFT*2u)))
...
#define CapSense_Sns_LinearSlider0_e7__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__7__SHIFT*2u)))
...
#define CapSense_Sns_LinearSlider0_e8__LS_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__8__SHIFT*2u)))
...
#define CapSense_Sns_Button0__BTN_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__9__SHIFT*2u)))
...
#define CapSense_Sns_Button1__BTN_INTR	((uint16)((uint16)0x0003u << (CapSense_Sns__10__SHIFT*2u)))
